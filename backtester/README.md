...
- `scripts/fix_dates.py` - script to add close time column and time zone info
- `strategies/mean_reversion` - Mean Reversion strategy
- `strategies/trend_following_style_1` - Trend Following strategy with "style 1" TP/SLs
- `strategies/trend_following_style_2` - Trend Following strategy with "style 2" TP/SLs
...
To prepare data
```sh
python3 scripts/fix_dates.py --filename MNQ_1min_sample.csv
```
...
```sh
python3 visualization/display_trend_following_style2.py --trades 0:21
```
