...
def test_model():
    ...
    if signal == 'long':
        ...
        print(f"⚠️  UNEXPECTED: Model predicted {signal.upper()} for upward trend")
    ...
    if signal == 'short':
        ...
        print(f"⚠️  UNEXPECTED: Model predicted {signal.upper()} for downward trend")
    ...
    if H > 0.5:
        ...
        print(f"ℹ️  INFO: Hurst H = {H:.4f} indicates {'mean-reverting' if H < 0.5 else 'random walk'} behavior")
